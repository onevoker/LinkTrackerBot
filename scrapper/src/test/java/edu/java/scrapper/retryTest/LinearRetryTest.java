...
public class LinearRetryTest {
    ...
    private final RetryFactory retryFactory = new RetryFactory(List.of(new LinearRetry()));
    private final Retry linearRetry = retryFactory.createRetry(retrySettings);
    ...
    void testRetry(int httpStatusCode) {
        ...
        assertThrows(
            ...
            () -> webClient.get()
                ...
                .transformDeferred(RetryOperator.of(linearRetry))
                .block()
        );
